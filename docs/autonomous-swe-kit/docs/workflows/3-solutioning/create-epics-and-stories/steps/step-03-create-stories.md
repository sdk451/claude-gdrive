...
# Path Definitions
workflow_path: '{project-root}/docs/workflows/3-solutioning/create-epics-and-stories'
...
# Task References
advancedElicitationTask: '{project-root}/docs/workflows/advanced-elicitation/workflow.xml'
partyModeWorkflow: '{project-root}/docs/workflows/party-mode/workflow.md'
...
### 7. LOAD STORIES TO LINEAR

After all epics and stories are complete: Load the stories to Linear via MCP


## CRITICAL STEP COMPLETION NOTE

ONLY WHEN [all epics and stories saved to document following the template structure exactly], will you then read fully and follow: `{nextStepFile}` to begin final validation phase.
